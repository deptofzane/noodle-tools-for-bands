        ...
        <p className="text-sm text-neutral-500 pb-4">
          ...
          {songCount > 0 && (
            <Link
              ...
              className="mt-2 rounded-md border h-12 md:h-9 border-neutral-300 px-4 py-3 md:py-1.5 md:px-3 text-sm font-medium hover:bg-neutral-50 disabled:opacity-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
            >
              Practice
            </Link>
          )}
